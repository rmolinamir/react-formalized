...
The `Context` and `Provider` exports are used to set up the CSS color themes by using CSS variables behind the scene. As you may have realized, `Context` is the React Context object generated by `React.createContext(initialContextx)`.
